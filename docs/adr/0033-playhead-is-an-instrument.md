...
# 0033. The playhead is an instrument, not content

[ADR-0019](0019-content-colour-palette.md) put the playhead on the exhaustive list of places
...
This is [ADR-0032](0032-measure-treatments-on-target-surface.md) repeating one level
...
**The floor is 3 : 1 and no colour-only trade is booked.** [ADR-0009](0009-runway-clock-disk-guard.md)
