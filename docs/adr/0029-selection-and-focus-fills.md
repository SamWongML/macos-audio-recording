...
# 0029. The selection fill is the system's; the focus ring is ours
...
[ADR-0025](0025-library-row-and-inspector.md) already assumed this and
...
This is not [ADR-0019](0019-content-colour-palette.md) territory. The accent in that fill is the
...
ADR asks of it. Verified on screen at 1200 × 680 and at the 960 × 552 floor, in both appearances: *(That floor was **552**; [#114](https://github.com/SamWongML/macos-audio-recording/issues/114) moved it to **656** — the code declares a content height of 604 and the window adds the 52 pt title bar ([ADR-0038](0038-dock-fill.md); `safeAreaBar` itself costs nothing). The verification stands as taken; the number it names is historical.)*
