...
# 0036. The Export dock's boundary is the system's, and it is conditional

*(Amended by [ADR-0038](0038-dock-fill.md). The modifier stands and
...
([ADR-0025](0025-library-row-and-inspector.md)): it *"separates by air and
by alignment"*, because a darkening bar over a column that already reads as separate is the
decorative chrome [ADR-0019](0019-content-colour-palette.md) spends its budget avoiding.
...
by 93–118 pt ([ADR-0030](0030-editor-default-height.md)'s numbers: the column
...
Gain, which is issue #55 and [ADR-0013](0013-loudness-clamped-gain.md).
