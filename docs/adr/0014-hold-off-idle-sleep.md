...
# 0014. A Recording holds off idle system sleep, but only the idle timer
...
is released, the Recording ends clean with all-real samples and no dropout, and ADR-0009's notification
