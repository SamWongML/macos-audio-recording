...
# 0032. A treatment is measured on the surface it lands on, in both appearances
...
- [ADR-0025](0025-library-row-and-inspector.md) gave the trailing column
...
where it needs to be subordinate and legible where `.tertiary` was not. **Where a hierarchical preset row
...
colour: [ADR-0019](0019-content-colour-palette.md)'s *chrome stays on system materials* stands, and
