...
# 0030. The trailing column sets the editor's default height
...
Above 620 the lane has all the height [ADR-0023](0023-detail-pane-layout.md)
allows it, and every further point becomes air below the summary. That ADR asks for the air: the pane
is *lane, brief, air, transport*, and the cap exists precisely so a tall window cannot smear one
row waveform across four hundred points.
...
*(Amended by [ADR-0036](0036-dock-boundary.md) in two
...
*(Corrected by [ADR-0038](0038-dock-fill.md): **read that second
...
[ADR-0027](0027-transport-readout-width.md) made for the transport's readouts and
[ADR-0025](0025-library-row-and-inspector.md) for the sidebar's glyph rail
...
pt below the summary is a visible band.
...
[ADR-0017](0017-activation-policy.md) interferes — this is per-window frame
