...
Each line arrived correctly and separately. [ADR-0023](0023-detail-pane-layout.md)
gave the detail its second line on report 0002's grounding — *say what to do next*.
[ADR-0024](0024-trailing-column-not-inspector.md) kept the column's own empty state
...
**Nothing invites the first capture.** [ADR-0017](0017-activation-policy.md)
