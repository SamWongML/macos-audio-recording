...
# 0039. In Dark the panes' fill and the step between them come from the wallpaper
...
- **A `separatorColor` hairline**, full window height — `1.363 : 1` in Dark, wallpaper-independent,
  ...
  ([ADR-0019](0019-content-colour-palette.md)).
- **Taking the sidebar off the material** — `windowBackgroundColor` plus
  [ADR-0032](0032-measure-treatments-on-target-surface.md)'s scrim, which makes the
...
([ADR-0025](0025-library-row-and-inspector.md),
[ADR-0035](0035-trailing-column-top-edge.md)). The sidebar boundary gets
