...
# 0035. The trailing column's fill reaches the window's top edge

[ADR-0034](0034-single-empty-state.md) emptied the trailing column: it holds the Export
...
Nothing about [ADR-0032](0032-measure-treatments-on-target-surface.md) moves: the
...
inspector dropout *"starts at the literal top of the window"*, and WWDC20's *Adopt the new look of
