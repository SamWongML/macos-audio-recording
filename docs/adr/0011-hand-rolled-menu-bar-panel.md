...
[ADR-0004](0004-nsstatusitem-transport.md) knowingly forfeited. A future reader who
...
[ADR-0008](0008-denied-grant-inferred.md) infers a denied grant from 3 s of
...
**One message surface, most-recent-reason-wins.** [ADR-0009](0009-runway-clock-disk-guard.md)
...
[ADR-0010](0010-silence-and-dropouts.md)'s unrequested ends already name their reason
