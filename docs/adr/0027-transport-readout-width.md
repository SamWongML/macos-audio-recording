...
# 0027. The transport reserves its widest readout
...
[ADR-0024](0024-trailing-column-not-inspector.md) deleted the `.inspector`, and the
...
[ADR-0025](0025-library-row-and-inspector.md) made the sidebar's glyph rail
