...
# 0008. A denied grant is inferred from silence, never reported
...
[ADR-0007](0007-faults-pad-dropouts.md) decided by reasoning: a revocation
...
[ADR-0006](0006-library-is-a-folder.md) makes the folder the truth with no index to mark a
