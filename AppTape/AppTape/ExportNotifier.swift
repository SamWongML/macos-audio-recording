...
/// A failed Export is told louder than a success: in-window always, and — when the app is
/// not frontmost — also as a system notification, because a silent failure at second 40 while
/// the user is in another app is the one outcome that must not be missable.
enum ExportNotifier {
