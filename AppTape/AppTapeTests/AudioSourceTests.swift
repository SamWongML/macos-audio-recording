...
struct AudioSourceTests {
    ...
    @Test func helperBundleMapsByPrefix() {
        let helper = AudioProcess(
            id: 10, pid: 100, bundleID: "com.google.Chrome.helper",
    ...
    @Test func webkitGPUMapsByLocalizedName() {
        ...
        let gpu = AudioProcess(
            id: 20, pid: 200, bundleID: "com.apple.WebKit.GPU",
    ...
    @Test func unownedProcessMapsToNothing() {
        let stray = AudioProcess(
            id: 30, pid: 300, bundleID: "com.unknown.thing",
            isRunningOutput: true, appName: nil)
        #expect(SourceResolution.owningBundleID(of: stray, among: [chrome, safari]) == nil)
    }

    @Test func sourceFansOutToItsProcessObjectIDs() {
        let audioService = AudioProcess(
            id: 11, pid: 101, bundleID: "com.google.Chrome.helper",
            isRunningOutput: true, appName: nil)
        let gpuHelper = AudioProcess(
            id: 12, pid: 102, bundleID: "com.google.Chrome.helper.Renderer",
    ...
    @Test func playingSourcesSortFirstThenAlphabetical() {
        ...
        let zuluAudio = AudioProcess(
            id: 40, pid: 400, bundleID: "com.z.App",
            isRunningOutput: true, appName: nil)
